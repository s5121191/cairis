...
class UseCaseEnvironmentProperties(EnvironmentProperties):
  def __init__(self,environmentName,preCond='',steps = None,postCond='',cAttributes=[0,0,0,0,0],caRationale=[None,None,None,None,None],ucDef='',ucAv=0):
